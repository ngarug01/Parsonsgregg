...
class WholeClassExerciseTest {
    ...
    private final WholeClassExercise wholeClassExercise = new WholeClassExercise(compiler, capturedOutputCheckers,classCheckers,methodReturnValueCheckers,"MY NAME",1);
